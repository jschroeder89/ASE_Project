...
public:
  ...
  std::array<PCA9544<true>, 2> HW_qPCA9544;

  std::array<VI2CDriver, 4> V_I2C2;
  //Obstacle-Sensoren
  std::array<VI2CDriver, 4> V_qI2C1;
  std::array<VI2CDriver, 4> V_qI2C2;

  std::array<VCNL4020, 4> vcnl4020;
  //Obstacle-Sensoren
  std::array<VCNL4020, 8> vcnlq4020;
...
public:
  Global() :
    ...
    //Sensorkonfiguration aus Powermanagement global.hpp        
    HW_qPCA9544{{PCA9544<true>(&HW_I2C1, 0x07u),
                PCA9544<true>(&HW_I2C2, 0x07u)}
              },
    V_qI2C1{{VI2CDriver(&HW_qPCA9544[0], 0),
            VI2CDriver(&HW_qPCA9544[0], 1),
            VI2CDriver(&HW_qPCA9544[0], 2),
            VI2CDriver(&HW_qPCA9544[0], 3)}
          },
    V_qI2C2{{VI2CDriver(&HW_qPCA9544[1], 0),
            VI2CDriver(&HW_qPCA9544[1], 1),
            VI2CDriver(&HW_qPCA9544[1], 2),
            VI2CDriver(&HW_qPCA9544[1], 3)}
          },
    vcnlq4020{{/* rear left        */ VCNL4020(&V_qI2C1[1], &vcnl4020_config),
              /* left side rear   */ VCNL4020(&V_qI2C1[3], &vcnl4020_config),
              /* left side front  */ VCNL4020(&V_qI2C1[2], &vcnl4020_config),
              /* front left       */ VCNL4020(&V_qI2C2[0], &vcnl4020_config),
              /* front right      */ VCNL4020(&V_qI2C2[1], &vcnl4020_config),
              /* right side front */ VCNL4020(&V_qI2C2[3], &vcnl4020_config),
              /* right side rear  */ VCNL4020(&V_qI2C2[2], &vcnl4020_config),
              /* rear right       */ VCNL4020(&V_qI2C1[0], &vcnl4020_config)}
            },
    //------------------//
