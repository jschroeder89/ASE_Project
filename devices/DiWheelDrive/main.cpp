...
//  boardRequestShutdown();
 ...
 for (i = 0x00; i < global.vcnlq4020.size(); i++) {
    global.vcnlq4020[i].requestTerminate();
    global.vcnlq4020[i].wait();
  }
  //------------//
...
//  boardWriteIoPower(1);
  ...
  //Obstacle-Sensoren
  for (i = 0x00u; i < global.vcnlq4020.size(); i++) {
    global.vcnlq4020[i].start(NORMALPRIO);
  }
  //------------//
